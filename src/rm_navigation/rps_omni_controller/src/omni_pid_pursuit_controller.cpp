#include "rps_omni_controller/omni_pid_pursuit_controller.hpp"
...
void OmniPidPursuitController::cleanup()
{
  RCLCPP_INFO(
    ...
    " rps_omni_controller::OmniPidPursuitController",
    plugin_name_.c_str());
...
void OmniPidPursuitController::activate()
{
  RCLCPP_INFO(
    ...
    "rps_omni_controller::OmniPidPursuitController (%s Mode)",
    plugin_name_.c_str(),
...
PLUGINLIB_EXPORT_CLASS(
  rps_omni_controller::OmniPidPursuitController, nav2_core::Controller)
